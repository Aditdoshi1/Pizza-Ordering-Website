...
$(document).ready(function() {
  $('#main-nav li a').click(function(e) {
	...
	<body>
		...
		<form class = "modal-content animate" action = "Pizzahut.php" method = "POST">
	...
	<div id  = "modal-wrapper1" class = "modal1">
		...
		<form class = "modal-content1 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper2" class = "modal2">
		...
		<form class = "modal-content2 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper3" class = "modal3">
		...
		<form class = "modal-content3 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper4" class = "modal4">
		...
		<form class = "modal-content4 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper5" class = "modal5">
		...
		<form class = "modal-content5 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper6" class = "modal6">
		...
		<form class = "modal-content6 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper7" class = "modal7">
		...
		<form class = "modal-content7 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper8" class = "modal8">
		...
		<form class = "modal-content8 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper9" class = "modal9">
		...
		<form class = "modal-content9 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper10" class = "modal10">
		...
		<form class = "modal-content10 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper11" class = "modal11">
		...
		<form class = "modal-content11 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper12" class = "modal12">
		...
		<form class = "modal-content12 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper13" class = "modal13">
		...
		<form class = "modal-content13 animate" action = "cart.html">
	...
	<div id  = "modal-wrapper14" class = "modal14">
		...
		<form class = "modal-content14 animate" action = "cart.html">
	...
	window.onclick = function(event) {
		...
		<section>
			...
			<div class = "products">
				...
				<ul>
				<li><a class= "img"><img src = "pv1.jpg" width = "150" onclick= "document.getElementById('modal-wrapper').style.display='block'"></a> 
					<button onclick = "document.getElementById('modal-wrapper').style.display='block'"><center>PeppyPanner</center></button>
				</li>
				<li><a class = "img1"><img src = "pv2.jpg" width = "150" onclick="document.getElementById('modal-wrapper1').style.display='block'"></a> 
					<button onclick = "document.getElementById('modal-wrapper1').style.display='block'"><center>FarmHouse</center></button>
				</li>
				<li><a class = "img2"><img src = "pv3.jpg" width = "150" onclick = "document.getElementById('modal-wrapper2').style.display='block'"></a> 
					<button onclick = "document.getElementById('modal-wrapper2').style.display='block'"><center>5 Peppers</center></button>
				 </li>
				<li><a class = "img3"><img src = "pv4.jpg" width = "150" onclick = "document.getElementById('modal-wrapper3').style.display='block'"></a> 
					<button onclick = "document.getElementById('modal-wrapper3').style.display='block'"><center>Dulex Veggie</center></button>
				</li>
				<li> <a class = "img4"><img src = "pv5.jpg" width = "150" onclick = "document.getElementById('modal-wrapper4').style.display='block'"></a> 
